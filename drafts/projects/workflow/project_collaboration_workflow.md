...
- [嵌入式软硬件协同开发规范与工作流程（迭代周期指南）](#嵌入式软硬件协同开发规范与工作流程迭代周期指南)
  - [1. 协作目标](#1-协作目标)
  - [2. 分工职责](#2-分工职责)
    - [2.1 软件开发（你）](#21-软件开发你)
    - [2.2 硬件开发（同事）](#22-硬件开发同事)
  - [3. Git 协作约定](#3-git-协作约定)
    - [3.1 分支模型（推荐 Git Flow 简化版）](#31-分支模型推荐-git-flow-简化版)
    - [3.2 提交规范](#32-提交规范)
    - [3.3 代码审查](#33-代码审查)
  - [4. 软件架构与分层规范](#4-软件架构与分层规范)
    - [4.1 目录规范](#41-目录规范)
    - [4.2 分层约束](#42-分层约束)
  - [5. 硬件协作规范](#5-硬件协作规范)
    - [5.1 硬件文档清单（每轮迭代提供）](#51-硬件文档清单每轮迭代提供)
    - [5.2 硬件小报告格式（不超过 100 字）](#52-硬件小报告格式不超过-100-字)
  - [6. 周期性迭代流程（建议 2 周一轮）](#6-周期性迭代流程建议-2-周一轮)
  - [7. 常用协作产物模板](#7-常用协作产物模板)
    - [7.1 《迭代计划》模板](#71-迭代计划模板)
    - [7.2 《系统联调记录》模板](#72-系统联调记录模板)
    - [7.3 《Release Note》模板](#73-release-note模板)
  - [8. 总结](#8-总结)
