...
- [目录](#目录)
- [总体流程（一页版）](#总体流程一页版)
- [目前计划的 Workflow](#目前计划的-workflow)
- [撰写规范（质量控制）](#撰写规范质量控制)
- [测试与 CI（轻量级）](#测试与-ci轻量级)
- [版本分支--协作git-工作流](#版本分支--协作git-工作流)
- [发布渠道与格式（业余友好）](#发布渠道与格式业余友好)
- [检查清单（发布前必须通过）](#检查清单发布前必须通过)
- [迭代范例（如何从-mvp-变成完整版）](#迭代范例如何从-mvp-变成完整版)
